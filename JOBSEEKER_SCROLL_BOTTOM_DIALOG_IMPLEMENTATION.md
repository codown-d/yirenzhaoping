  ...
  <DialogContent className="max-w-sm mx-auto">
    ...
    <div className="space-y-4 pt-4">
      ...
      <div className="text-center pt-2">
        <p className="text-xs text-gray-500">选择身份后将跳转到登录页面</p>
      </div>
    </div>
  </DialogContent>
</Dialog>;
...
- **相同的触发机制**: 滚动到底部附近（距离底部 100px 以内）
- **相同的延时设置**: 1 秒延时确保用户确实停留在底部
- **相同的节流控制**: 100ms 节流避免频繁触发
- **相同的弹窗设计**: 统一的 Dialog 样式和交互
